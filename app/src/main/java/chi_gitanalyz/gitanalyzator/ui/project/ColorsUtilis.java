...
public class ColorsUtilis {
    ...
    public static final int[] COLORS = new int[]{COLOR_Green,COLOR_NavyBlue, COLOR_LightSlateBlue, COLOR_Cyan
            , COLOR_Red, COLOR_DarkGreen,COLOR_DeepPink,COLOR_DarkOliveGreen};
}
